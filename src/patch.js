...
import { valueIn, repeatString, deepCopy, unique } from "./util";
import { JSON_INDENT, flattenStringDiff } from "./diffutil";
import { validateObjectOp, validateSequenceOp } from "./diffentries";
import { DiffRangeRaw } from "./range";
...
export function patch(base, diff) {
  if (typeof base === "string") {
